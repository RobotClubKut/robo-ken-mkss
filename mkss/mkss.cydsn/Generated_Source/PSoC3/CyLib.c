...
*  function. The Interrupt componentfs API should be used to register the
...
*  componentfs API should be used to manipulate with the associated interrupts.
*
* Parameters:
*  None
*
...
*  outside the detectorfs trip point. They stay set to 1 until they are read or
