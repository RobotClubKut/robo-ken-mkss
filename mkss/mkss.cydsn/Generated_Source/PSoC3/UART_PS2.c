...
/*******************************************************************************
* Function Name: UART_PS2_Start
********************************************************************************
*
* Summary:
*  This is the preferred method to begin component operation.
*  UART_PS2_Start() sets the initVar variable, calls the
*  UART_PS2_Init() function, and then calls the
*  UART_PS2_Enable() function.
*
* Parameters:
*  None.
*
...
*
* Global variables:
*  The UART_PS2_intiVar variable is used to indicate initial
*  configuration of this component. The variable is initialized to zero (0u)
*  and set to one (1u) the first time UART_PS2_Start() is called. This
*  allows for component initialization without re-initialization in all
*  subsequent calls to the UART_PS2_Start() routine.
*
* Reentrant:
*  No.
*
...
/*******************************************************************************
* Function Name: UART_PS2_Init
********************************************************************************
*
* Summary:
*  Initializes or restores the component according to the customizer Configure
*  dialog settings. It is not necessary to call UART_PS2_Init() because
*  the UART_PS2_Start() API calls this function and is the preferred
...
void UART_PS2_Init(void) 
{
        ...
        /* Init Count7 period */
        UART_PS2_RXBITCTR_PERIOD_REG = UART_PS2_RXBITCTR_INIT;
        /* Configure the Initial RX interrupt mask */
        UART_PS2_RXSTATUS_MASK_REG  = UART_PS2_INIT_RX_INTERRUPTS_MASK;
    ...
    #if(UART_PS2_PARITY_TYPE_SW)  /* Write Parity to Control Register */
...
/*******************************************************************************
* Function Name: UART_PS2_Enable
********************************************************************************
*
* Summary:
*  Activates the hardware and begins component operation. It is not necessary
*  to call UART_PS2_Enable() because the UART_PS2_Start() API
...
*
* Global Variables:
*  UART_PS2_rxAddressDetected - set to initial state (0).
*
*******************************************************************************/
void UART_PS2_Enable(void) 
{
    ...
    enableInterrupts = CyEnterCriticalSection();
        ...
        UART_PS2_RXBITCTR_CONTROL_REG |= UART_PS2_CNTR_ENABLE;

        /* Enable the RX Interrupt */
        UART_PS2_RXSTATUS_ACTL_REG  |= UART_PS2_INT_ENABLE;
            ...
            #endif /* (UART_PS2_RXHW_ADDRESS_ENABLED) */
        #endif /* (UART_PS2_RX_INTERRUPT_ENABLED) */
    #endif /* (UART_PS2_RX_ENABLED || UART_PS2_HD_ENABLED) */
    ...
    #if (UART_PS2_INTERNAL_CLOCK_USED)
        UART_PS2_IntClock_Start();  /* Enable the clock */
    #endif /* (UART_PS2_INTERNAL_CLOCK_USED) */
...
void UART_PS2_Stop(void) 
{
    ...
    #if (UART_PS2_RX_ENABLED || UART_PS2_HD_ENABLED)
        UART_PS2_RXBITCTR_CONTROL_REG &= (uint8) ~UART_PS2_CNTR_ENABLE;
    #endif /* (UART_PS2_RX_ENABLED || UART_PS2_HD_ENABLED) */
    ...
    #if (UART_PS2_INTERNAL_CLOCK_USED)
        UART_PS2_IntClock_Stop();   /* Disable the clock */
    #endif /* (UART_PS2_INTERNAL_CLOCK_USED) */

    /* Disable internal interrupt component */
    #if (UART_PS2_RX_ENABLED || UART_PS2_HD_ENABLED)
        UART_PS2_RXSTATUS_ACTL_REG  &= (uint8) ~UART_PS2_INT_ENABLE;
...
/*******************************************************************************
* Function Name: UART_PS2_ReadControlRegister
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: UART_PS2_WriteControlRegister
********************************************************************************
*
* Summary:
...
void  UART_PS2_WriteControlRegister(uint8 control) 
{
...
#if(UART_PS2_RX_ENABLED || UART_PS2_HD_ENABLED)
    /*******************************************************************************
    * Function Name: UART_PS2_SetRxInterruptMode
    ********************************************************************************
    *
    * Summary:
    ...
    *      UART_PS2_RX_STS_FIFO_NOTEMPTY    Interrupt on byte received.
    *      UART_PS2_RX_STS_PAR_ERROR        Interrupt on parity error.
    *      UART_PS2_RX_STS_STOP_ERROR       Interrupt on stop error.
    *      UART_PS2_RX_STS_BREAK            Interrupt on break.
    *      UART_PS2_RX_STS_OVERRUN          Interrupt on overrun error.
    *      UART_PS2_RX_STS_ADDR_MATCH       Interrupt on address match.
    *      UART_PS2_RX_STS_MRKSPC           Interrupt on address detect.
    *
    * Return:
    *  None.
    *
    ...
    *******************************************************************************/
    ...
    {
        UART_PS2_RXSTATUS_MASK_REG  = intSrc;
    }


    /*******************************************************************************
    * Function Name: UART_PS2_ReadRxData
    ********************************************************************************
    *
    * Summary:
    ...
    *  UART_PS2_rxBufferLoopDetect - cleared if loop condition was detected
    *     in RX ISR.
    *
    * Reentrant:
    *  No.
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: UART_PS2_ReadRxStatus
    ********************************************************************************
    *
    * Summary:
    ...
    *  UART_PS2_RX_STS_FIFO_NOTEMPTY.
    *  UART_PS2_RX_STS_FIFO_NOTEMPTY clears immediately after RX data
    *  register read.
    *
    * Global Variables:
    *  UART_PS2_rxBufferOverflow - used to indicate overload condition.
    *   It set to one in RX interrupt when there isn't free space in
    *   UART_PS2_rxBufferRead to write new data. This condition returned
    *   and cleared to zero by this API as an
    *   UART_PS2_RX_STS_SOFT_BUFF_OVER bit along with RX Status register
    *   bits.
    *
    *******************************************************************************/
    uint8 UART_PS2_ReadRxStatus(void) 
    {
        ...
        status = UART_PS2_RXSTATUS_REG & UART_PS2_RX_HW_MASK;
    ...
    /*******************************************************************************
    * Function Name: UART_PS2_GetChar
    ********************************************************************************
    *
    * Summary:
    *  Returns the last received byte of data. UART_PS2_GetChar() is
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: UART_PS2_GetByte
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    #else
        return ( ((uint16)UART_PS2_ReadRxStatus() << 8u) | UART_PS2_ReadRxData() );
    #endif /* UART_PS2_RX_INTERRUPT_ENABLED */
    ...
    /*******************************************************************************
    * Function Name: UART_PS2_GetRxBufferSize
    ********************************************************************************
    *
    * Summary:
    ...
    *
    * Global Variables:
    *  UART_PS2_rxBufferWrite - used to calculate left bytes.
    *  UART_PS2_rxBufferRead - used to calculate left bytes.
    *  UART_PS2_rxBufferLoopDetect - checked to decide left bytes amount.
    *
    * Reentrant:
    *  No.
    *
    ...
    *******************************************************************************/
                                                            ...
                                                            
    {
        ...
        size = ((UART_PS2_RXSTATUS_REG & UART_PS2_RX_STS_FIFO_NOTEMPTY) != 0u) ? 1u : 0u;
    ...
    /*******************************************************************************
    * Function Name: UART_PS2_ClearRxBuffer
    ********************************************************************************
    *
    * Summary:
    ...
    *
    * Global Variables:
    *  UART_PS2_rxBufferWrite - cleared to zero.
    *  UART_PS2_rxBufferRead - cleared to zero.
    *  UART_PS2_rxBufferLoopDetect - cleared to zero.
    *  UART_PS2_rxBufferOverflow - cleared to zero.
    *
    * Reentrant:
    *  No.
    *
    ...
    *******************************************************************************/
    void UART_PS2_ClearRxBuffer(void) 
    {
        ...
        /* Clear the HW FIFO */
        enableInterrupts = CyEnterCriticalSection();
        UART_PS2_RXDATA_AUX_CTL_REG |= (uint8)  UART_PS2_RX_FIFO_CLR;
        UART_PS2_RXDATA_AUX_CTL_REG &= (uint8) ~UART_PS2_RX_FIFO_CLR;
        CyExitCriticalSection(enableInterrupts);
    ...
    /*******************************************************************************
    * Function Name: UART_PS2_SetRxAddressMode
    ********************************************************************************
    *
    * Summary:
    ...
    *  UART_PS2__B_UART__AM_SW_BYTE_BYTE -  Software Byte-by-Byte address
    *                                               detection
    *  UART_PS2__B_UART__AM_SW_DETECT_TO_BUFFER - Software Detect to Buffer
    *                                               address detection
    *  UART_PS2__B_UART__AM_HW_BYTE_BY_BYTE - Hardware Byte-by-Byte address
    *                                               detection
    *  UART_PS2__B_UART__AM_HW_DETECT_TO_BUFFER - Hardware Detect to Buffer
    *                                               address detection
    *  UART_PS2__B_UART__AM_NONE - No address detection
    *
    * Return:
    *  None.
    *
    * Global Variables:
    *  UART_PS2_rxAddressMode - the parameter stored in this variable for
    ...
    *******************************************************************************/
    ...
    /*******************************************************************************
    * Function Name: UART_PS2_SetRxAddress1
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        UART_PS2_RXADDRESS1_REG = address;
    }


    /*******************************************************************************
    * Function Name: UART_PS2_SetRxAddress2
    ********************************************************************************
    *
    * Summary:
    ...
    *******************************************************************************/
    ...
    {
        UART_PS2_RXADDRESS2_REG = address;
    }
