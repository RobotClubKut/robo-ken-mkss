...
module UART_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("54f9c7ee-4478-4bea-87cc-d549d80b561e/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
// UART_v2_50(Address1=0, Address2=0, BaudRate=38400, BreakBitsRX=13, BreakBitsTX=13, BreakDetect=false, CRCoutputsEn=false, Enable_RX=1, Enable_RXIntInterrupt=0, Enable_TX=0, Enable_TXIntInterrupt=0, EnableHWAddress=0, EnIntRXInterrupt=false, EnIntTXInterrupt=false, FlowControl=0, HalfDuplexEn=false, HwTXEnSignal=true, InternalClock=true, InternalClockToleranceMinus=3.93736842105263, InternalClockTolerancePlus=3.93736842105263, InternalClockUsed=1, InterruptOnAddDetect=0, InterruptOnAddressMatch=0, InterruptOnBreak=1, InterruptOnByteRcvd=1, InterruptOnOverrunError=0, InterruptOnParityError=0, InterruptOnStopError=1, InterruptOnTXComplete=false, InterruptOnTXFifoEmpty=false, InterruptOnTXFifoFull=false, InterruptOnTXFifoNotFull=false, IntOnAddressDetect=false, IntOnAddressMatch=false, IntOnBreak=true, IntOnByteRcvd=true, IntOnOverrunError=false, IntOnParityError=false, IntOnStopError=true, NumDataBits=8, NumStopBits=1, OverSamplingRate=8, ParityType=0, ParityTypeSw=false, RequiredClock=307200, RXAddressMode=0, RXBufferSize=4, RxBuffRegSizeReplacementString=uint8, RXEnable=true, TXBitClkGenDP=true, TXBufferSize=4, TxBuffRegSizeReplacementString=uint8, TXEnable=false, Use23Polling=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=UART_v2_50, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UART_PS2, CY_INSTANCE_SHORT_NAME=UART_PS2, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=50, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3, INSTANCE_NAME=UART_PS2, )
module UART_v2_50_2 (
    rx_clk,
    rx_data,
    tx_clk,
	...
	cy_clock_v1_0
		#(.id("7667c206-84e7-41aa-942a-e9ea2e9c702d/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
    ...
    UART_v2_50_0 UART_Servo (
        ...
        .rx_data(Net_46),
        .rx_clk(Net_47));
    defparam UART_Servo.Address1 = 0;
    defparam UART_Servo.Address2 = 0;
    defparam UART_Servo.EnIntRXInterrupt = 1;
    defparam UART_Servo.EnIntTXInterrupt = 0;
    defparam UART_Servo.FlowControl = 0;
    defparam UART_Servo.HalfDuplexEn = 0;
    defparam UART_Servo.HwTXEnSignal = 1;
    defparam UART_Servo.NumDataBits = 8;
    defparam UART_Servo.NumStopBits = 1;
    defparam UART_Servo.ParityType = 1;
    defparam UART_Servo.RXEnable = 1;
    defparam UART_Servo.TXEnable = 1;
    ...
    defparam UART_Debug.EnIntTXInterrupt = 1;
    defparam UART_Debug.FlowControl = 0;
    defparam UART_Debug.HalfDuplexEn = 0;
    defparam UART_Debug.HwTXEnSignal = 1;
    defparam UART_Debug.NumDataBits = 8;
    defparam UART_Debug.NumStopBits = 1;
    defparam UART_Debug.ParityType = 0;
    defparam UART_Debug.RXEnable = 0;
    defparam UART_Debug.TXEnable = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("f6988564-828a-4ced-bb8a-45ac2bb26908"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PS2_IN_net;
	wire [0:0] tmpIO_0__PS2_IN_net;
	wire [0:0] tmpINTERRUPT_0__PS2_IN_net;
	electrical [0:0] tmpSIOVREF__PS2_IN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .input_buffer_sel(2'b00))
		PS2_IN
		 (.oe(tmpOE__PS2_IN_net),
		  .y({1'b0}),
		  .fb({Net_92}),
		  .io({tmpIO_0__PS2_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__PS2_IN_net),
		  .interrupt({tmpINTERRUPT_0__PS2_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PS2_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    UART_v2_50_2 UART_PS2 (
        .cts_n(1'b0),
        .tx(Net_112),
        .rts_n(Net_113),
        .tx_en(Net_114),
        ...
        .reset(Net_104),
        .rx(Net_92),
        .tx_interrupt(Net_116),
        .rx_interrupt(Net_117),
        .tx_data(Net_118),
        .tx_clk(Net_119),
        .rx_data(Net_120),
        .rx_clk(Net_121));
    defparam UART_PS2.Address1 = 0;
    defparam UART_PS2.Address2 = 0;
    defparam UART_PS2.EnIntRXInterrupt = 0;
    defparam UART_PS2.EnIntTXInterrupt = 0;
    defparam UART_PS2.FlowControl = 0;
    defparam UART_PS2.HalfDuplexEn = 0;
    defparam UART_PS2.HwTXEnSignal = 1;
    defparam UART_PS2.NumDataBits = 8;
    defparam UART_PS2.NumStopBits = 1;
    defparam UART_PS2.ParityType = 0;
    defparam UART_PS2.RXEnable = 1;
    defparam UART_PS2.TXEnable = 0;
